...
public class DaoFactory {
	...
	static {
	    ResourceBundle bundle = PropertyResourceBundle.getBundle("dao.dao");
	    ...
	    try {
	      daoFactory = new DaoFactory(driver,jdbcURL, username, password,preconnectCount, maxIdleConnections,maxConnections);
	    } catch (Exception ex) {
	      ex.printStackTrace();
	    }
	  }
	
	protected DaoFactory(String aDriver,String aJdbcURL, String aUsername,String aPassword, int aPreconnectCount,int aMaxIdleConnections,int aMaxConnections)
